...
public class gestionVenta {
    ...
    public ResponseEntity<VentaResponseDTO> actualizar (@Parameter(description = "ID de el venta a actualizar,añadiendo como endpoint (PUT)",example = "1") @RequestBody VentaRequestDTO dto, @PathVariable Long id){
    ...
    public ResponseEntity<Void> eliminarProducto(@Parameter(description = "ID de el venta a eliminar",example = "1") @PathVariable Long id){
